...
const navItems = [
  ...
  { href: '/meals', label: 'Meal Plans', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
...
export default function Navigation() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <nav className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 bg-white border-r border-gray-200 flex-col z-10">
        <div className="p-6 border-b border-gray-100">
          <h1 className="text-xl font-bold text-primary-700">Home Food Manager</h1>
          <p className="text-sm text-gray-500 mt-1">Kitchen assistant</p>
        </div>
